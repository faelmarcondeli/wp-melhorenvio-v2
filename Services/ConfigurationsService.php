...
class ConfigurationsService {
        ...
        public function saveConfigurations( $data ) {
                ...
                if ( isset( $data['restrict_frontend_pages'] ) ) {
                        $response['restrict_frontend_pages'] = $this->setRestrictFrontendPages(
                                $data['restrict_frontend_pages']
                        );
                }
        ...
        public function getConfigurations() {
                ...
                return array(
                        ...
                        'restrict_frontend_pages' => $this->getRestrictFrontendPages(),
                );
        }
        ...
        /**
         * Function to save the restrict frontend pages option
         *
         * @param bool $restrict
         * @return array
         */
        public function setRestrictFrontendPages( $restrict ) {
                delete_option( 'melhor_envio_restrict_frontend_pages' );
                add_option( 'melhor_envio_restrict_frontend_pages', $restrict );
        ...
        /**
         * Function to get the restrict frontend pages option
         *
         * @return bool
         */
        public function getRestrictFrontendPages() {
                return filter_var( get_option( 'melhor_envio_restrict_frontend_pages', 'false' ), FILTER_VALIDATE_BOOLEAN );
        }
